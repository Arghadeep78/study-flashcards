...
export default function RandomReview() {
  ...
  return (
    <div className="max-w-md mx-auto mt-24 space-y-6 text-center">
      ...
      <h1 className="text-2xl font-bold text-zinc-100">Random Review</h1>
      <p className="text-zinc-500 text-sm">Pick a random batch from your entire deck.</p>

      <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6 space-y-5 text-left">
        <div>
          ...
          <div className="flex items-center gap-3">
            ...
            />
            <span className="w-10 text-center text-sm font-mono text-zinc-200 bg-zinc-800 rounded-lg py-1">{count}</span>
          </div>
        </div>
